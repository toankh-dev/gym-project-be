...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkUpdate('members', { current_subscription_id: 1 }, { id: 1 });
        await queryInterface.bulkUpdate('members', { current_subscription_id: 2 }, { id: 2 });
        await queryInterface.bulkUpdate('members', { current_subscription_id: 3 }, { id: 3 });
    },
    async down(queryInterface, Sequelize) {
        // Clear current subscription references
        await queryInterface.bulkUpdate('members', { current_subscription_id: null }, {});
        await queryInterface.bulkDelete('member_subscriptions', {}, {});
    }
};
//# sourceMappingURL=008-subscriptions.js.map